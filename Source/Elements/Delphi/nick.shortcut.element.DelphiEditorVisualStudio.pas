...
begin
  ...
  AddShortCut(NewShortCut('Edit|Undo', Vcl.Menus.ShortCut(VK_BACK, [ssAlt]), scNone, ''));
  ...
  AddShortCut(NewShortCut('Converts the word under the cursor to lower case', Vcl.Menus.ShortCut(Ord('K'), [ssCtrl]), Vcl.Menus.ShortCut(Ord('E'), []), ''));
  ...
  AddShortCut(NewShortCut('Search|Search Again', Vcl.Menus.ShortCut(Ord('L'), [ssCtrl]), scNone, ''));
  ...
  AddShortCut(NewShortCut('Deletes to the end of a line', Vcl.Menus.ShortCut(Ord('Y'), [ssCtrl]), scNone, ''));
