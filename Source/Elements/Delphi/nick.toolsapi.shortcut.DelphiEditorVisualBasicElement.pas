unit nick.toolsapi.shortcut.DelphiEditorVisualBasicElement;
...
begin
  ...
  AddShortCut(NewShortCut('Open file at cursor', Menus.ShortCut(Ord('G'), [ssCtrl]), scNone, ''));
  ...
  AddShortCut(NewShortCut('Converts the word under the cursor to lower case', Menus.ShortCut(Ord('K'), [ssCtrl]), Menus.ShortCut(Ord(' '), []), ''));
  ...
  AddShortCut(NewShortCut('Deletes a line', Menus.ShortCut(Ord('L'), [ssCtrl]), scNone, ''));
  ...
  AddShortCut(NewShortCut('Inserts a new line character', Menus.ShortCut(VK_RETURN, []), scNone, ''));
  AddShortCut(NewShortCut('Toggles insert mode', Menus.ShortCut(VK_INSERT, []), scNone, ''));
...
initialization
  nick.toolsapi.shortcut.ShortCutRepository.GetShortCutRepository().Add(TDelphiEditorVisualBasicElement);
