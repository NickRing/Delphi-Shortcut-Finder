unit nick.toolsapi.shortcut.Castalia2014;

interface

uses
  nick.toolsapi.shortcut.PackageExpertBaseElement,
  Windows;
...
begin
  ...
  nick.toolsapi.shortcut.ShortCutItemBuilder.NewShortCutItemBuilder(Self)
                                            ...
                                            .WithShortCut(Menus.ShortCut(Ord(' '), []))
                                            .IsRegistry()
                                            .WithPath(cSOFTWARE_TWODESK_CASTALIA_OPTION)
  ...
  nick.toolsapi.shortcut.ShortCutItemBuilder.NewShortCutItemBuilder(Self)
                                            ...
                                            .WithShortCut(Menus.ShortCut(VK_F2, []))
                                            .IsRegistry()
                                            .WithPath(cSOFTWARE_TWODESK_CASTALIA_OPTION)
  ...
  nick.toolsapi.shortcut.ShortCutItemBuilder.NewShortCutItemBuilder(Self)
                                            ...
                                            .WithShortCut(Menus.ShortCut(Ord('W'), [ssCtrl]))
                                            .IsRegistry()
                                            .WithPath(cSOFTWARE_TWODESK_CASTALIA_OPTION)
  ...
  nick.toolsapi.shortcut.ShortCutItemBuilder.NewShortCutItemBuilder(Self)
                                            ...
                                            .WithShortCut(Menus.ShortCut(Ord('S'), [ssShift, ssCtrl]))
                                            .IsRegistry()
                                            .WithPath(cSOFTWARE_TWODESK_CASTALIA_OPTION)
  ...
  nick.toolsapi.shortcut.ShortCutItemBuilder.NewShortCutItemBuilder(Self)
                                            ...
                                            .WithShortCut(Menus.ShortCut({/}VK_OEM_2, []))
                                            .WithActiveState(True)
                                            .IsRegistry()
                                            .WithPath(cSOFTWARE_TWODESK_CASTALIA_OPTION)
  ...
  nick.toolsapi.shortcut.ShortCutItemBuilder.NewShortCutItemBuilder(Self)
                                            ...
                                            .WithShortCut(Menus.ShortCut(Ord('U'), [ssAlt, ssCtrl]))
                                            .IsRegistry()
                                            .WithPath(cSOFTWARE_TWODESK_CASTALIA_OPTION)
  ...
  nick.toolsapi.shortcut.ShortCutItemBuilder.NewShortCutItemBuilder(Self)
                                            ...
                                            .WithDescription('Configuration: Options -> Editor -> Navigation tools -> Keyboard shortcuts')
                                            .WithShortCut(Menus.ShortCut(Ord('S'), [ssAlt, ssCtrl]))
                                            .IsRegistry()
                                            .WithPath(cSOFTWARE_TWODESK_CASTALIA_OPTION)
  ...
  nick.toolsapi.shortcut.ShortCutItemBuilder.NewShortCutItemBuilder(Self)
                                            ...
                                            .WithDescription('Configuration: Options -> Editor -> Navigation tools -> Keyboard shortcuts')
                                            .WithShortCut(Menus.ShortCut(Ord('C'), [ssAlt, ssCtrl]))
                                            .IsRegistry()
                                            .WithPath(cSOFTWARE_TWODESK_CASTALIA_OPTION)
  ...
  nick.toolsapi.shortcut.ShortCutItemBuilder.NewShortCutItemBuilder(Self)
                                            ...
                                            .WithDescription('Configuration: Options -> Editor -> Navigation tools -> Keyboard shortcuts')
                                            .WithShortCut(Menus.ShortCut(Ord('P'), [ssAlt, ssCtrl]))
                                            .IsRegistry()
                                            .WithPath(cSOFTWARE_TWODESK_CASTALIA_OPTION)
  ...
  nick.toolsapi.shortcut.ShortCutItemBuilder.NewShortCutItemBuilder(Self)
                                            ...
                                            .WithDescription('Configuration: Options -> Editor -> Navigation tools -> Keyboard shortcuts')
                                            .WithShortCut(Menus.ShortCut(VK_RIGHT, [ssAlt, ssCtrl]))
                                            .IsRegistry()
                                            .WithPath(cSOFTWARE_TWODESK_CASTALIA_OPTION)
  ...
  nick.toolsapi.shortcut.ShortCutItemBuilder.NewShortCutItemBuilder(Self)
                                            ...
                                            .WithDescription('Configuration: Options -> Editor -> Navigation tools -> Keyboard shortcuts')
                                            .WithShortCut(Menus.ShortCut(VK_LEFT, [ssAlt, ssCtrl]))
                                            .IsRegistry()
                                            .WithPath(cSOFTWARE_TWODESK_CASTALIA_OPTION)
  ...
  nick.toolsapi.shortcut.ShortCutItemBuilder.NewShortCutItemBuilder(Self)
                                            ...
                                            .WithDescription('Configuration: Options -> Editor -> Navigation tools -> Keyboard shortcuts')
                                            .WithShortCut(Menus.ShortCut(Ord('N'), [ssAlt, ssCtrl]))
                                            .IsRegistry()
                                            .WithPath(cSOFTWARE_TWODESK_CASTALIA_OPTION)
  ...
  nick.toolsapi.shortcut.ShortCutItemBuilder.NewShortCutItemBuilder(Self)
                                            ...
                                            .WithShortCut(Menus.ShortCut(Ord('R'), [ssAlt, ssCtrl]))
                                            .IsRegistry()
                                            .WithPath(cSOFTWARE_TWODESK_CASTALIA_OPTION)
...
initialization
  nick.toolsapi.shortcut.ShortCutRepository.GetShortCutRepository().Add(TCastalia2014Element);
